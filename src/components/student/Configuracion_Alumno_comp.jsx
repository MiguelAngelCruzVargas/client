...
export function Configuracion_Alumno_comp() {
    ...
    useEffect(() => {
        const loadUserData = async () => {
            setIsLoading(true);
            try {
                // TODO: API call to /api/students/profile
                // const response = await fetch('/api/students/profile');
                // const userData = await response.json();
                // setProfile(userData.profile);
                // setLearningPreferences(userData.preferences);
            } catch (error) {
    ...
    const handleDeleteAccount = () => {
        ...
        if (confirmation) {
            ...
            if (doubleConfirmation === 'ELIMINAR') {
                // TODO: API call to /api/students/delete-account
    ...
    const handleSaveChanges = async (e) => {
        ...
        setIsLoading(true);
        try {
            // TODO: API call to /api/students/profile/update
            // const response = await fetch('/api/students/profile/update', {
            //     method: 'PUT',
            //     headers: { 'Content-Type': 'application/json' },
            //     body: JSON.stringify({ profile, learningPreferences })
            // });
    ...
    const handleChangePassword = async (e) => {
        ...
        setIsLoading(true);
        try {
            // TODO: API call to /api/students/change-password
        ...
        input.onchange = async (e) => {
            ...
            if (file) {
                ...
                try {
                    ...
                    // TODO: API call to /api/students/profile/upload-photo
                    // const formData = new FormData();
                    // formData.append('photo', file);
                    // const response = await fetch('/api/students/profile/upload-photo', {
                    //     method: 'POST',
                    //     body: formData
                    // });
