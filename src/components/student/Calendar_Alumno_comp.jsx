...
// Modal para crear recordatorios personales
...
// Modal para mostrar notificaciones de recordatorios
...
// Modal para mostrar eventos del día en móviles
...
// Componente principal del calendario del estudiante
export function Calendar_Alumno_comp({ eventsData, isLoading = false, error = null }) {
  ...
  // Datos iniciales (mock data para desarrollo)
  ...
  // Sincronizar eventos con datos del backend
  useEffect(() => {
    if (eventsData) {
  ...
  // Controlar scroll del body con modales abiertos
  useEffect(() => {
    const hasOpenModal = isPaymentModalOpen || isConfirmationModalOpen || 
                        isReminderCreationModalOpen || isReminderNotificationModalOpen || 
                        isMobileEventsModalOpen;
  ...
  useEffect(() => {
    ...
    // Mostrar primer recordatorio pendiente
  ...
  // Eventos importantes para sidebar
  ...
  const handleMarkAsPaid = (eventId) => {
    ...
    // TODO: API call to /api/payments/confirm
  };
  ...
  const handleSaveReminder = ({ name, description, date, priorityColor }) => {
    ...
    // TODO: API call to /api/students/reminders
  };
  ...
  const handleDismissReminder = (reminderId) => {
    ...
    // TODO: API call to /api/students/reminders/{id}/dismiss
  };

  // Manejar clic en días (móviles)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                {days.map((day, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Tooltip para desktop - SOLO para desktop */}
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between gap-4">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent leading-tight">
                EVENTOS IMPORTANTES
              </h2>
              <div className="flex-shrink-0">
                <span className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 text-sm font-bold rounded-full border border-blue-200">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3 mb-1">
                            <div className="flex-1">
                              ...
                              {/* Información adicional con estados */}
...
export default Calendar_Alumno_comp;