...
const SimulatorResultsChart = ({ simulatorGrades, useSimulatedData = true }) => {
  ...
  // Calcular promedio general y mejor resultado
  const scores = dataToRender.map(item => item.score);
  ...
  return (
    <div className="cursor-pointer transition-all duration-200 hover:scale-105">
      ...
      {/* Barras horizontales para todas las simulaciones */}
      ...
      {/* Información adicional - Promedio General y Mejor Resultado */}
      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="text-center">
...
/**
 * Componente interno para la gráfica circular del módulo específico (PieChart)
 * @param {Object} props - Propiedades del componente
    ...
    <div className="w-full font-inter text-gray-800">
      ...
      >
        <div className="space-y-6">
          ...
          {/* Gráfica de barras verticales con Recharts - consistente con otras métricas */}
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h4 className="text-lg font-semibold text-gray-800 mb-4 text-center">Desempeño por Materia</h4>
            <div style={{ width: '100%', height: '400px' }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={MODULO_ESPECIFICO_ACTIVO.materias}
                ...
                >
                  ...
                  <YAxis 
                    ...
                    label={{ value: 'Progreso (%)', angle: -90, position: 'insideLeft', style: { textAnchor: 'middle', fill: '#374151' } }}
                  />
                  <Tooltip 
                  ...
                  <Bar 
                    ...
                    maxBarSize={60}
                  >
                    {MODULO_ESPECIFICO_ACTIVO.materias.map((entry, index) => {
                      const colors = [
                        '#10b981', // green
                        '#3b82f6', // blue
                        '#f59e0b', // yellow
