        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4 xs:mb-6 sm:mb-8">
            <h1 className="text-lg xs:text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-1 xs:mb-2 px-2">
              Validación de Pagos y Contratos
            </h1>
          ...
          <div className="mb-4 xs:mb-6 sm:mb-8">
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-6 shadow-2xl border-2 border-gray-200 hover:shadow-3xl transition-all duration-300">
          ...
          {activeCategory && (
            <div className="mb-4 xs:mb-6 sm:mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-6 shadow-2xl border-2 border-blue-200 hover:shadow-3xl transition-all duration-300">
                <h2 className="text-base xs:text-lg sm:text-xl font-bold text-gray-800 mb-3 xs:mb-4 sm:mb-6 text-center px-2">
                  Seleccionar Turno para {activeCategory}
                </h2>
