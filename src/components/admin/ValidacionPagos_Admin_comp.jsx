/**
 * Componente de Gestión de Contratos Admin solo que antes era ValidaciónPagos
 * Maneja la generación y gestión de contratos para alumnos con pagos ya aprobados
 * 
 * Endpoints del Backend Requeridos:
 * - GET /api/admin/students/approved?curso={curso}&turno={turno} - Obtener alumnos aprobados
 * - POST /api/admin/contracts/{id}/generate - Generar contrato PDF
 * - POST /api/admin/contracts/{id}/upload - Subir contrato firmado
 * - GET /api/admin/contracts/{id}/view - Visualizar contrato
 */

import React, { useState, useEffect } from 'react';
import { PDFDocument, rgb, StandardFonts } from 'pdf-lib';
import jsPDF from 'jspdf';
import { generarYDescargarContrato } from '../../services/contractPDFService';
import { generarPDFCalibracion } from '../../services/pdfCalibrationService';
